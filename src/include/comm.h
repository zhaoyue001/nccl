...
// Forward declaration — defined in device.h
typedef void (*ncclOpLaunchFunc_t)(void* kernelFn, struct dim3 grid, struct dim3 block, void** args, size_t smem, struct CUstream_st* stream);
#include "nccl_net.h"
#include "register.h"
...
struct ncclKernelPlan {
  ...
  void *kernelFn;
  ncclOpLaunchFunc_t kernelLaunchFn;   // launch function from per-op .so (NULL → default cudaLaunchKernel)
